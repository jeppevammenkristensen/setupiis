...
{
    public class SetupIisSiteOperation : IOperation
    {
        public void Run(string[] args)
        {
            ...
            var appPool = manager.ApplicationPools.FirstOrDefault(x => x.Name == localVeluxDev) ??
                          manager.ApplicationPools.Add(localVeluxDev);
